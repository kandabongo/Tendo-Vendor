...
class NewProductViewModel extends ProductManageViewModel {
  ...
  processNewProduct() async {
    if (formBuilderKey.currentState!.saveAndValidate()) {
      ...
      try {
        ...
        productData.addAll({"description": productDescription});
  ...
  //
  void filterSubcategories(List<int?>? categoryIds) {
    categoryIds ??= [];
    subCategories =
        unFilterSubCategories.where((e) {
          return categoryIds!.contains(e.categoryId);
        }).toList();
    notifyListeners();
  }

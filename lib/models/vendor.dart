...
class Vendor {
  ...
  factory Vendor.fromJson(Map<String, dynamic> json) {
    return Vendor(
      ...
      autoAssignment:
          json["auto_assignment"] == null
              ? false
              : ["true", "1", true, 1].contains(json["auto_assignment"])
              ? true
              : false,
      //
      documentRequested:
          json["document_requested"] == null
              ? false
  ...
  bool get isBookingType {
    return (vendorType != null && vendorType?.slug == "booking");
  }
  ...
  bool canServiceLocation(DeliveryAddress deliveryaddress) {
    ...
    //cities
    final foundCity = this.cities.firstOrNullWhere((element) {

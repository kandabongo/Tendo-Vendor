...
import 'package:fuodz/views/pages/order/order_booking_details.page.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case AppRoutes.orderBookingDetailsRoute:
      return MaterialPageRoute(
        settings: RouteSettings(name: AppRoutes.orderBookingDetailsRoute),
        builder:
            (_) => OrderBookingDetailsPage(order: settings.arguments as Order),
      );
